...
concerned is known as the **coverage probability**, i.e., the probability that the 
constructed interval contains (or covers) the true parameter of interest. The 
coverage probability is often expressed as the term $1 - \alpha$, where $\alpha$
is some value between 0 and 1.  In other words, $\alpha$ represents the 
