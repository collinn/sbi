...
**Confidence Interval: ** <em> An interval estimate which contains the true population parameter according to a 
  specified confidence level. </em>
...
**Type I error: ** <em> Rejecting a true null hypothesis. False positive. </em>

**Type II error: ** <em> Failing to reject a false null hypothesis. False negative. </em>
