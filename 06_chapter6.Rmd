...
Probability distributions describe the true chances of observing different 
quantities, and we associate this with the distribution in the 
*population*.

and when we sample data according to some distribution we generally
expect it to have a similar shape. However, 
