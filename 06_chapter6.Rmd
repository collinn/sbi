...
Finally, let's discuss how probability distributions relate back to our general statistical
framework. In our framework we have some unknown parameters which describe the 
population. These are exactly the same parameters that govern our probability 
distributions. In other words, probability distributions describe the true 
chances of observing different quantities in the *population*. When we collect a 
sample, we expect the data to have a distribution similar to the true population
distribution
