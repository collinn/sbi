...
success/failure trials, such as counting the number of days before a lightbulb 
burns out
...
of success is the same between trials. Notably, as the data from a binomial distribution
...
To illustrate another examplea of the binomial distribution, we might consider 
...
a failure to be rolling a 1, 2, 3, or 5. As there are six equally likely outcomes, 
...
from 1875-1972 in feet. Next, the annual flow of the river Nile from 1871-1970 
measured in cubic meters. Lastly, the recorded height, in feet, of 31 black cherry 
...
of the family of **continuous distribtuions**. Instead of asking the probability 
...
# then the polygon is drawn, then the curve again to be over the polygone.
