...
[[we don't refer to sample mean as expected value, but rather the expected value of sample mean is mean. idk, reword]]
...
What the Central Limit Theorem (CLT) states is this: so long as the size of our sample is "large enough", the sampling distribution of $\overline{X}$ will be approximately normal, regardless of the characteristics of the underlying distribuiton. That is, we have
