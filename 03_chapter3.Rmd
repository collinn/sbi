...
Before a study can begin, subjects must be enrolled and consent to performing in a study. Typically, elligible participants are selected for a study based on a set of elligibility criterion to ensure that subjects come from a population of interest. For example, in a study designed to test the efficiacy of a new medication for lowering cholesterol, clinicians may only select subjects who have a demonstrated risk for heart disease. Similarly, it is often important to have a set of criteria that can *exclude* certain subjects, such as those with confounding issues that may make it difficult to limit the amount of variability in a study. 
