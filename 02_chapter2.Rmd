...
on a scatter plot represent one observation. In the plot below, we have put
...
We see that there is a distinct relationship between ozone concentration and temperature.
...
these picture can be informative for answering and producing important research
